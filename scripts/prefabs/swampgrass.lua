...
local function spawner()
	...
	inst:DoTaskInTime(0, function()
		for i=1,math.random(8, 15) do
			local grass = SpawnPrefab("swampgrass")
			...
			grass.Transform:SetPosition(x + math.cos(theta)*dist, y, z + math.sin(theta)*dist)
			inst:Remove()
		end
	end)
...
return Prefab("swampgrass", fn, assets, prefabs),
	Prefab("swampgrass_spawner", spawner)
