...
local function fn()
	...
	inst.MiniMap:SetPriority(5)
	inst.MiniMap:SetIcon("basefan.png")
...
return Prefab("fumesfan", fn, assets, prefabs)--, 
	--MakePlacer("fumesfan_placer", "firefighter_placement", "firefighter_placement", "idle", true, nil, nil, 1.55)